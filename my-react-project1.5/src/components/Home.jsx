  ...
  return (
    <div className="home">
      <section id="home" className="hero">
          ...
          <br />
          <br />
          <a href="/admissions" className="cta-button" title="Click here to Apply now"><i>Apply Now</i></a>
          <br />
          <br />
      </section>
      ...
      <section id="contact" className="contact">
          ...
          <br />
          <a href="/contact" className="cta-button" title="Click here to Contact us"><i>Contact Us</i></a>
      </section>
